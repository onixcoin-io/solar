...
func init() {
	cli := app.Command("prefund", "(onix) fund an owner address with utxos")
	...
	appTasks["prefund"] = func() (err error) {
		...
		/*
			...
			2. "amounts"             (string, required) A json object with addresses and amounts
			    {
			      "address":amount   (numeric or string) The onix address is the key, the numeric amount (can be string) in ONIX is the value
			      ,...
			    }
		*/
